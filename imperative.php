      ...
      <div class="row">
        <div class="column left">
          ...
          <text><? echo iconv("tis-620", "utf-8", $rows['Details']);?><text><br>
            <a href="pdf3/ข้อบังคับหลักเกณฑ์และอัตราค่ารักษาพยาบาลกรณีผู้ป่วยฉุกเฉิน.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
          <br><br>
          ...
          <a href="pdf3/ข้อบังคับการช่วยเหลือพนักงานเกี่ยวกับการรักษาพยาบาล (ฉบับที่ 7) พ.ศ. 2565.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
          <br><br>
          ...
          <a href="pdf3/ระเบียบวิธีการเบิกจ่ายเงินช่วยเหลือพนักงานเกี่ยวกับการรักษาพยาบาล (ฉบับที่ 11) พ.ศ. 2565.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
        </div>
        ...
        <div class="column right" >
            ...
            <a href="pdf3/ข้อบังคับสวัสดิการเกี่ยวกับค่ารักษาพยาบาลของลูกจ้าง (ฉบับที่ 7) พ.ศ. 2565.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
            <br><br>
            ...
            <a href="pdf3/ระเบียบการเบิกจ่ายเงินสวัสดิการเกี่ยวกับค่ารักษาพยาบาลของลูกจ้าง (ฉบับที่ 7) พ.ศ. 2565.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
            <br><br>
            ...
            <a href="pdf3/ข้อบังคับเงินช่วยเหลือในการจัดการศพผู้ปฏิบัติงาน (ฉบับที่ 2) พ.ศ. 2565.pdf" download/Download File><i class='far fa-hand-point-right' style='font-size:16px'></i> Download <i class='far fa-hand-point-left' style='font-size:16px'></i></a>
          </div>
      </div>
</body>
</html>
