  ...
  <div class="row">
    ...
    ?>
      <div class="box5">
        ...
        <div class="entry">
          <center>
            <img id="showimg" src="uploads/<?php echo $image ?> " height="230px">

          </center><br>

          <p class="p1"><? echo $header ?><br><a button id="myBtn" href="#popup_flight_travlDil<? echo $header; ?>"><span>อ่านต่อ </span></a></p>
        </div>
      </div>
    <?php } ?>
