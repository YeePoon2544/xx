...
<body>
    ...
    <form action="labor/storelabor.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
        <div align="center">
            <h2>เพิ่มข้อมูลพระราชบัญญัติแรงงานรัฐวิสาหกิจสัมพันธ์</h2>
        </div>
        <h5>ไฟล์รูปภาพพระราชบัญญัติแรงงานรัฐวิสาหกิจสัมพันธ์</h5>
        ...
        <h5>ไฟล์ข้อมูลพระราชบัญญัติแรงงานรัฐวิสาหกิจสัมพันธ์</h5>
        <div class="w3-row w3-section">
